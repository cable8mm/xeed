...
final class UnsignedSmallIntegerResolverTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->column = Picker::of($db->attach()
            ->getTable('xeeds')
            ->getColumns()
        )->driver($db->driver)->field('unsigned_small_integer')->get();
    ...
    public function test_migration_method_can_working_well(): void
    {
        ...
        if ($this->driver == 'mysql') {
            $this->assertEquals('$table->unsignedSmallInteger(\''.$resolver->field.'\')->nullable();', $resolver->migration());
        }
